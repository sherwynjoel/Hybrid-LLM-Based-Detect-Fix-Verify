# PyCharm Plugin - Hybrid LLM Vulnerability Repair

## Overview

PyCharm plugin for real-time vulnerability detection and repair using the Hybrid LLM framework.
...
1. **PyCharm 2023.1 or later**
2. **IntelliJ Platform SDK** (included with PyCharm)
...
This creates a `.zip` file in `build/distributions/` that can be installed in PyCharm.
...
- Check PyCharm version (requires 2023.1+)
...
- Ensure file is supported (Python, Java, JS, TS, C/C++)
